...
# # giraffe_dict = {}
#
# # for giraffe in os.listdir("../../data/coco_minitrain_25k/images_pruned/giraffes_elephants/giraffe"):
# #     path = os.path.join(imagesRoot+'/elephant', elephant)
# #
# #     image = cv2.imread(path)
# #     image = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)
...
# #
# #     plt.imshow(final_mask)
# #     plt.savefig("../../data/coco_minitrain_25k/annotations/elephant_masks/{}".format(giraffe))